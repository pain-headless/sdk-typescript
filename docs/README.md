...
For full type definitions, parameter options, and advanced strategies (like custom pagination functions and proxy sticky sessions), please refer to your IDE's JSDoc tooltips or build the docs using `Typedoc`.
